...
if(isset($_POST['submit'])){
    ...
    $hstate=$_POST['hstate'];
    $hzip=$_POST['hzip'];
    $sql="INSERT into hospital value ($hid,'$hname','$hst_addrress','$hst_city','$hstate',$hzip)";
    if(mysqli_query($conn,$sql)){
        echo '<script>alert("New hospital record of  *** '.$hname.'  *** inserted")</script>';
    }else{
...
<div class="card shadow mb-4 mt-4">
            <div class="card-header py-3">
              <h3 class="m-0 font-weight-bold text-primary float-left">New Hospital</h3>
            </div>
            ...
            <div class="container py-4 px-5 bg-light rounded">
              ...
              <form method="POST" class="form-wrapper px-5">
              	<div class="form-group">
              		<label class="h6">hospital's id <span class="light" style="color: #cacaca;"></span></label><br>
              		<div class="row">
              			<div class="col-md-6">
              	...
              	<div class="form-group">
              		<div class="row">
              			<div class="col-md-6">
              				<label class="h6">hospital's name</label><br>
              				
              				<input type="text" name="hname" placeholder="JOHN Hospital" required class="form-control form-control-user">
              			</div>
              			<div class="col-md-6">
		              		<label class="h6">address</label><br>
              				<input type="text" name="hst_addrress" required class="form-control form-control-user">
              			</div>
              			</div>
              	</div>
              	<div class="form-group">
              		...
              		<div class="col-md-6">
              				...
              				<input type="text" name="hst_city" required class="form-control form-control-user">
              			</div>
              			<div  class="col-md-6">
              				<label class="h6">state</label><br>
              				<input type="text" name="hstate" required class="form-control form-control-user">
              			</div>
              		</div>
              	</div>
              	<div class="form-group">
              		...
              		<div class="row">
              			<div class="col-md-6">
              				 <input type="text" name="hzip" required class="form-control form-control-user">
              			</div>
